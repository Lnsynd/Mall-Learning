...
import com.lqs.mall.component.RestAuthenticationEntryPoint;
import com.lqs.mall.component.RestfulAccessDeniedHandler;
...
/**
 * Security配置
 * Created by 刘千山 on 2023/6/20/020-14:47
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .permitAll().antMatchers("/esProduct/**", "/member/readHistory/**")// 搜索及会员浏览记录暂时允许匿名访问
